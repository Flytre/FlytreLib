...
public class IndividualConfigScreen<T> extends GenericConfigScreen {
    ...
    private TranslucentButton fileOpener;
    private TranslucentButton helpMac;
    private TranslucentButton helpWindows;
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        this.fileOpener.render(matrices, mouseX, mouseY, delta);
        this.helpWindows.render(matrices, mouseX, mouseY, delta);
        this.helpMac.render(matrices, mouseX, mouseY, delta);
    }
    ...
    protected void init() {
        ...
        fileOpener = new TranslucentButton(width / 2 - width / 10, height - 30, width / 5, 20, new TranslatableText("flytre_lib.gui.open_file"), (button) -> {
        ...
        helpMac = new TranslucentButton(width / 2 - width / 5 - width/5, height - 30, width / 5, 20, new TranslatableText("flytre_lib.gui.help_mac"), (button) -> {
            try {
        ...
        helpWindows = new TranslucentButton(width / 2 + width / 5, height - 30, width / 5, 20, new TranslatableText("flytre_lib.gui.help_windows"), (button) -> {
            try {
