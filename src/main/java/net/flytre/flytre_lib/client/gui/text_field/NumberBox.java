...
import net.flytre.flytre_lib.config.Range;
...
public class NumberBox extends TranslucentTextField {
    ...
    public NumberBox(int x, int y, int width, int height, Text message, boolean integers, @Nullable Range range, double startingValue) {
