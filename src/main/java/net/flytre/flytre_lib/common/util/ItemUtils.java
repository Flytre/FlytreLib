...
import net.flytre.flytre_lib.mixin.AbstractBlockAccessor;
import net.flytre.flytre_lib.mixin.MiningToolItemAccessor;
...
public class ItemUtils {
    ...
    public static Optional<Integer> getLuminance(Item item) {
        ...
        if (def.getProperties().contains(net.minecraft.state.property.Properties.LIT))
