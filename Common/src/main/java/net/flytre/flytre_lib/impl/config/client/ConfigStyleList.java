...
@ApiStatus.Internal
abstract class ConfigStyleList<E extends ConfigStyleList.Entry<E>> extends ElementListWidget<E> {
    ...
    protected abstract Entry<E> getEntryAtPosition2(double x, double y);


    public abstract static class Entry<E extends Entry<E>> extends ElementListWidget.Entry<E> implements ParentElement {
