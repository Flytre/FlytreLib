...
public class TranslucentCyclingOption<T> extends Option {
    ...
    private TranslucentCyclingOption(String key, Function<GameOptions, T> getter, Setter<T> setter, Supplier<TranslucentCyclingButtonWidget.Builder<T>> buttonBuilderFactory) {
        super(key);
        this.getter = getter;
        this.setter = setter;
    ...
    public static <T> TranslucentCyclingOption<T> create(String key, List<T> values, Function<T, Text> valueToText, Function<GameOptions, T> getter, Setter<T> setter) {
        return new TranslucentCyclingOption<>(key, getter, setter, () -> TranslucentCyclingButtonWidget.builder(valueToText).values(values));
    }

    public static <T> TranslucentCyclingOption<T> create(String key, Supplier<List<T>> valuesSupplier, Function<T, Text> valueToText, Function<GameOptions, T> getter, Setter<T> setter) {
    ...
    public static <T> TranslucentCyclingOption<T> create(String key, List<T> defaults, List<T> alternatives, BooleanSupplier alternativeToggle, Function<T, Text> valueToText, Function<GameOptions, T> getter, Setter<T> setter) {
    ...
    public static <T> TranslucentCyclingOption<T> create(String key, T[] values, Function<T, Text> valueToText, Function<GameOptions, T> getter, Setter<T> setter) {
        return new TranslucentCyclingOption<>(key, getter, setter, () -> TranslucentCyclingButtonWidget.builder(valueToText).values(values));
    }

    public static TranslucentCyclingOption<Boolean> create(String key, Text on, Text off, Function<GameOptions, Boolean> getter, Setter<Boolean> setter) {
        return new TranslucentCyclingOption<>(key, getter, setter, () -> TranslucentCyclingButtonWidget.onOffBuilder(on, off));
    }

    public static TranslucentCyclingOption<Boolean> create(String key, Function<GameOptions, Boolean> getter, Setter<Boolean> setter) {
        return new TranslucentCyclingOption<>(key, getter, setter, TranslucentCyclingButtonWidget::onOffBuilder);
    }

    public static TranslucentCyclingOption<Boolean> create(String key, Text tooltip, Function<GameOptions, Boolean> getter, Setter<Boolean> setter) {
