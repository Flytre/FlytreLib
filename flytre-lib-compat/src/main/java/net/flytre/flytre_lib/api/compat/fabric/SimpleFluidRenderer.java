...
public final class SimpleFluidRenderer {
    ...
    public static final class FluidRenderingDataImpl implements FluidRenderingData {
        ...
        public static FluidRenderingData from(Fluid fluid) {
            ...
            if (handler == null)
                return null;
            Sprite[] sprites = handler.getFluidSprites(MinecraftClient.getInstance().world, MinecraftClient.getInstance().world == null ? null : BlockPos.ORIGIN, fluid.getDefaultState());
            int color = -1;
            if (MinecraftClient.getInstance().world != null)
                color = handler.getFluidColor(MinecraftClient.getInstance().world, BlockPos.ORIGIN, fluid.getDefaultState());
