...
public class ListEditorWidget<K extends ClickableWidget> extends ConfigStyleList<ListEditorWidget.ValueEntry<K>> {
    ...
    @Environment(EnvType.CLIENT)
    public static class ValueEntry<K extends ClickableWidget> extends ConfigStyleList.Entry<ValueEntry<K>> {
